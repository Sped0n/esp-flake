    ...
    in
    {
      devShells = forAllSystems (
        ...
        let
          ...
          # Shared runtime libs for Matter + ESP-IDF userspace tooling.
          ...
          # Keep glibc out of LD_LIBRARY_PATH to avoid host /bin/sh skew.
          ldRuntimeLibs = runtimeLibs;

          # nix-ld needs glibc in its library search path.
          nixLdRuntimeLibs = [ pkgs.glibc ] ++ runtimeLibs;
          ...
          mkIdfShell =
            ...
            pkgs.mkShellNoCC {
              ...
              shellHook = ''
                ...
                export NIX_LD_LIBRARY_PATH="${lib.makeLibraryPath nixLdRuntimeLibs}:''${NIX_LD_LIBRARY_PATH_EXTRA-}"
                export LD_LIBRARY_PATH="${lib.makeLibraryPath ldRuntimeLibs}:''${LD_LIBRARY_PATH_EXTRA-}:''${LD_LIBRARY_PATH-}"
